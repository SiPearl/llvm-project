...
; CHECK-NEXT: LV(REG): RegisterClass: GPR, 2 registers
; CHECK-NEXT: LV(REG): RegisterClass: FPU/NEON/SVE, 72 registers
...
; CHECK-NEXT: LV(REG): Found max usage: 2 item
; CHECK-NEXT: LV(REG): RegisterClass: GPR, 2 registers
; CHECK-NEXT: LV(REG): RegisterClass: FPU/NEON/SVE, 36 registers
