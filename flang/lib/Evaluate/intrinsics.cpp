...
static const IntrinsicInterface genericIntrinsicFunction[]{
    ...
    {"cotan", {{"x", SameFloating}}, SameFloating},
    {"cotand", {{"x", SameFloating}}, SameFloating},
...
static const SpecificIntrinsicInterface specificIntrinsicFunction[]{
    ...
    {{"dcotan", {{"x", DoublePrecision}}, DoublePrecision}, "cotan"},
    {{"dcotand", {{"x", DoublePrecision}}, DoublePrecision}, "cotand"},
