...
void fir::runtime::genAllocatableAllocateSource(
    fir::FirOpBuilder &builder, mlir::Location loc, mlir::Value desc,
    mlir::Value source, mlir::Value hasStat, mlir::Value errMsg) {
  mlir::func::FuncOp func{
  ...
  llvm::SmallVector<mlir::Value> args{
      fir::runtime::createArguments(builder, loc, fTy, desc, source, hasStat,
