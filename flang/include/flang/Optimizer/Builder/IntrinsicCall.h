...
struct IntrinsicLibrary {
  ...
  void genAtomicCasCoarray(llvm::ArrayRef<fir::ExtendedValue> args);
  ...
  void genEventQuery(llvm::ArrayRef<fir::ExtendedValue>);
  mlir::Value genExponent(mlir::Type, llvm::ArrayRef<mlir::Value>);
  fir::ExtendedValue genExtendsTypeOf(mlir::Type,
                                      llvm::ArrayRef<fir::ExtendedValue>);
  template <Extremum, ExtremumBehavior>
  mlir::Value genExtremum(mlir::Type, llvm::ArrayRef<mlir::Value>);
  fir::ExtendedValue genFailedImages(mlir::Type,
                                     llvm::ArrayRef<fir::ExtendedValue>);
  ...
  fir::ExtendedValue genImageIndex(mlir::Type,
                                   llvm::ArrayRef<fir::ExtendedValue>);
  mlir::Value genImageStatus(mlir::Type, llvm::ArrayRef<mlir::Value>);
  ...
  fir::ExtendedValue genStoppedImages(mlir::Type,
                                      llvm::ArrayRef<fir::ExtendedValue>);
